...
function LeftSide() {
  ...
  return (
    <aside className="w-[305px] ">
      <div className="bg-[#332862] h-20 flex items-center justify-center">
        <Logo />
      </div>
      <div className="bg-indigo-500 space-y-8 pt-8 px-4 h-[calc(100vh_-_88px)]">
        {menus.map((menu) => (
          <button
            onClick={() => handleActiveMenu(menu.key)}
            className={`block w-full text-left px-12 ${
              activeMenu === menu.key
